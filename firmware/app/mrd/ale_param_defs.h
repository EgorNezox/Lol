...
#define ALE_TIME_TTuneTx			500
#define ALE_TIME_TOpenTx			200
#define ALE_TIME_TTuneRx			500
#define ALE_TIME_TEthTx				500
#define ALE_TIME_TEthRx				500
#define ALE_TIME_TRChan				16
#define ALE_TIME_DTMistiming		((ALE_TIME_TEthTx + ALE_TIME_TRChan + ALE_TIME_TEthRx)/2)
#define ALE_TIME_THshakeTransMode	(3024 + 100)
#define ALE_TIME_TRespCallQual		(2128 + 100)
#define ALE_TIME_THshakeReceiv		(448 + 100)
#define ALE_TIME_THshakeTrans		(448 + 100)
#define ALE_TIME_TmsgHeadL			(2576 + 100)
#define ALE_TIME_TpackHeadL			(2576 + 100)
#define ALE_TIME_TRespPackQualL		(1792 + 100)
#define ALE_TIME_TLinkReleaseL		(784 + 100)
...
#define ALE_TIME_TCall			(2128 + 100)
...
//																0		1		2		3		4		5		6		7
#define ALE_TIME_TDataL(sform)	(((sform) == -1)?(0):((int[]){	2640,	3960,	7920,	7920,	7392,	14784,	29568,	59136	}[(sform)] + 1500))
