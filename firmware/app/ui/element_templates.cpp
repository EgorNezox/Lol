...
GCOLOR GENERAL_TEXT_COLOR =				G_WHITE;
GCOLOR GENERAL_FORE_COLOR =				G_WHITE;
GCOLOR GENERAL_BACK_COLOR =				G_BLACK;
GCOLOR MENU_ITEM_INACTIVE_BACK_COLOR =	G_BLACK;
GCOLOR MENU_ITEM_INACTIVE_TEXT_COLOR =	G_WHITE;
GCOLOR MENU_ITEM_ACTIVE_BACK_COLOR =	G_WHITE;
GCOLOR MENU_ITEM_ACTIVE_TEXT_COLOR =	G_BLACK;
GCOLOR SPBOX_ACTIVE_BACK_COLOR =		G_WHITE;
GCOLOR SPBOX_ACTIVE_TEXT_COLOR =		G_BLACK;
GCOLOR SPBOX_INACTIVE_BACK_COLOR =		G_BLACK;
GCOLOR SPBOX_INACTIVE_TEXT_COLOR =		G_WHITE;
GCOLOR BATTERY_HIGH_COLOR =				G_WHITE;
