...
public:
    ...
    sigc::signal<std::vector<uint8_t>*, uint8_t /*номер файла*/, DataStorage::FS::TransitionFileType> loadVoiceMail;
    sigc::signal<std::vector<uint8_t>*, DataStorage::FS::FileType /*тип файла*/, DataStorage::FS::TransitionFileType, uint8_t /*номер файла*/> loadMessage;
