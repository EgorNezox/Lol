...
void CGuiMenu::initSheldureDialog(std::vector<std::string>* data, uint8_t sessionCount)
{
    ...
    MoonsGeometry labelArea   = { 7, 3, 120, 15 };
    MoonsGeometry length_geom = { 112,  2,  165,  15};
    MoonsGeometry sliderArea  = { 150, 25, 157, 110};
    ...
    case 1:
    {
        ...
        for (uint8_t subMenu = 0; subMenu < 5; subMenu++)
        {
            ...
            GUI_EL_MenuItem *item = new GUI_EL_MenuItem( &item_param, &item_geom, (char*)reciveSubMenu[subMenu], true, true, (GUI_Obj*)this );
            ScrollArea.addGuiElement(item);
        }
    ...
    case 3:
    {
        ...
        //GUI_EL_Window window ( &GUI_EL_TEMP_WindowGeneral, &windowArea,                          (GUI_Obj*)this );
        GUI_EL_Label  title  ( &titleParams,               &titleArea,  (char*)editSheldure_label, (GUI_Obj*)this );
        GUI_EL_Label label2 ( &param[0],                  &labelArea,  (char*)groupCondCommFreqStr, (GUI_Obj*)this );
