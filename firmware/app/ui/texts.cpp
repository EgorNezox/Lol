...
const char *technoSubMenu[]   = {" Генер.\0", " Адрес\0", " Версия\0", " ГукВвод\0", "Компьют\0", "Формат.\0",};
const char *technoSubMenuIn[] = {" Настр.генератора\0", " Адрес станции\0", " Версия ПО\0", "Размер команд ГУК\0", "Комп.\0", "Флэш\0"};
