...
const char *settingsSubMenu[] = {"ДВ\0", " Связь\0", " Скан\0", " Усиление\0", " Громкость\0", " Шумодав\0"," Время ГУК\0", " КР","Конф", "Зонд-ние\0"}; //TODO:
...
const char* zondSubMenu[]   = {"Зонд 1\0", "Зонд 2\0", "Зонд 3\0", "Зонд 4\0"};
