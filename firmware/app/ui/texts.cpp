...
const char *settingsSubMenuIn[] = {" Дата Время\0", " Связь\0", " Скан.\0", " Режим\0", " Звук\0",
                                 ...
                                 " Дисплей\0", " Технол.меню\0"  };

const char *technoSubMenu[]   = {" Генер.\0", " Адрес\0", " Версия\0", " ГукВвод\0"};
const char *technoSubMenuIn[] = {" Настр.генератора\0", " Адрес станции\0", " Версия ПО\0", "Размер команд ГУК\0"};
