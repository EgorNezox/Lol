...
const char* smatrHSStateStr[] = {
                                 "Воспроизведение невозможно(пустое сообщение)\nПовторите сеанс приема или выйдите\0",
                                 "Воспроизведение невозможно(гарнитура не подключена)\nПодключите гарнитуру СКЗИ\0",
                                 "Ошибка процедура прервана\nПодключенная гарнитура неисправна или имеетнесовмес- тимую конфигурацию\0",
                                 "Процедура на выбранном канале невозможна\nВыберите другой канал\0",
                                 "Подготовка сообщения для проигрывания...\nНе осуществляйте никаких действий с гарнитурой\0",
                                 "Проигрывание Сообщения...\nНе осуществляйте никаких действий с гарнитурой.\0",
                                 "Подготовка записи сообщения...\nНе осуществляйте никаких действий с гарнитурой\0",
                                 "Запись сообщения...\nНажмите и удерживайте тангенту гарнитуры для записи речи\0",
                                 "Истекло время ожидания записи\nПовторите процедуру или выйдите\0",
                                 "Готово\nНажмите Ввод для продолжения(или повторите процедуру)\0",
                                };
const char* aleStateStr[] = {
                             "...\0",
                             "Ошибка. Пропала синхронизация с ГНСС\nПереместите станцию под открытое небо и повторите пуск\0",
                             "Ошибка. Аппаратный сбой\nВыполнение данного сеанса невозможно\0",
                             "Ошибка. Не заданы частоты АУС по умолчанию\nДля планового сеанса необходима конфигурация частот АУС станции\0",
                             "Ошибка. Не задан собственный адресс стенции\nНеобходима конфигурация станции\0",
                             "Ошибка. Сеанс с ППРЧ не возможен\nНеобходима установка режима синхронизации времени от ГНСС и ключа радиосети\0",
                             "Подготовка сеанса\0",
                             "Ожидание входящего вызова...\0",
                             "Принят входящий вызов, согласование параметров обмена...\0",
                             ...
                             "Вызов принят, согласование параметров обмена\0",
