/************************* gicarc.c ********************************
   ...
   Revision Purpose:  Extrated to a seperate module for better code size
                      optimization possibilities.
                      Use of floating point calculations replaced with
   ...
   Version number: 1.2
   Copyright (c) RAMTEX International Aps 2009-2010
