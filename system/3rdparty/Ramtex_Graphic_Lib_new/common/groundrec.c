/************************* groundrec.c ********************************
   ...
   instead for the specified rounded corner:
   ...
   Version number: 1.2
   Copyright (c) RAMTEX International Aps 2008-2012
...
/*
   ...
   and 3 (0-3) rectangular areas: MID, LC, RC. If one or more of the
   arc areas are not used then the rectangular areas are optimized
   accordingly. Rectangular areas of size zero is skipped (ex when the
